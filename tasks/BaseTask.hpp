...
#ifndef GAZEBO_USV_BASETASK_TASK_HPP
#define GAZEBO_USV_BASETASK_TASK_HPP

#include "gazebo_usv/BaseTaskBase.hpp"
...
namespace gazebo_usv {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','gazebo_usv::BaseTask')
     end
     \endverbatim
    ...
    public:
         ...
         */
        BaseTask(std::string const& name = "gazebo_usv::BaseTask");
